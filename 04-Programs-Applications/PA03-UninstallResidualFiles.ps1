...
$Session = Start-KnouxSession -ToolId 'PA03' -ToolName 'Uninstall Residual Files' -Category '04-Programs-Applications' -RiskLevel 'DESTRUCTIVE' -Mode $(if ($AnalyzeOnly) { 'analyze' } elseif ($WhatIf) { 'preview' } else { 'run' })
$rc = 0
