              ...
              <div className="quick-actions-bar">
                {relevantTools.find(x => x.ToolId === 'SW01') && (
                  <button
                    ...
                    onClick={() => handleLaunchTool(relevantTools.find(x => x.ToolId === 'SW01')!, 'analyze')}
                  >
                    <Layers size={14} />
                ...
                {relevantTools.find(x => x.ToolId === 'SW02') && (
                  <button
                    type="button"
                    className="quick-action-pill"
                    onClick={() => handleLaunchTool(relevantTools.find(x => x.ToolId === 'SW02')!, 'analyze')}
                  >
                    <Terminal size={14} />
                ...
                {relevantTools.find(x => x.ToolId === 'SW04') && (
                  <button
                    type="button"
                    className="quick-action-pill"
                    onClick={() => handleLaunchTool(relevantTools.find(x => x.ToolId === 'SW04')!, 'preview')}
                  >
                    <Archive size={14} />
                ...
                {relevantTools.find(x => x.ToolId === 'SW05') && (
                  <button
                    type="button"
                    className="quick-action-pill"
                    onClick={() => handleLaunchTool(relevantTools.find(x => x.ToolId === 'SW05')!, 'analyze')}
                  >
