...
const SEED_WORKSPACES: Workspace[] = [
  { id: 'sonar', name: { en: 'Project Sonar', ar: 'مشروع سونار' }, code: 'SONAR-01', section: 'projectSonar', category: '18-Project-Sonar', state: 'active', accent: '#25c8dd', icon: '◉', lastActivity: { en: 'Live inventory', ar: 'جرد حي' }, owner: { en: 'Project intelligence', ar: 'ذكاء المشروع' } },
  { id: 'system', name: { en: 'System Care', ar: 'عناية النظام' }, code: 'SYS-CORE', section: 'maintenance', category: '01-System-Maintenance', state: 'active', accent: '#5d8dff', icon: '✦', lastActivity: { en: 'Ready for diagnosis', ar: 'جاهز للتشخيص' }, owner: { en: 'System health', ar: 'صحة النظام' } },
  { id: 'network', name: { en: 'Network Pulse', ar: 'نبض الشبكة' }, code: 'NET-24', section: 'network', category: '03-Network-Internet', state: 'active', accent: '#32c4d7', icon: '⌁', lastActivity: { en: 'Connection preview', ar: 'معاينة الاتصال' }, owner: { en: 'Connectivity', ar: 'الاتصال' } },
  { id: 'security', name: { en: 'Security Sentinel', ar: 'حارس الأمان' }, code: 'SEC-09', section: 'security', category: '09-Security', state: 'active', accent: '#31c88b', icon: '◆', lastActivity: { en: 'Protection preview', ar: 'معاينة الحماية' }, owner: { en: 'Protection posture', ar: 'حالة الحماية' } },
  { id: 'diagnostics', name: { en: 'Diagnostics Hub', ar: 'مركز التشخيص' }, code: 'DIA-10', section: 'diagnostics', category: '10-Diagnostics-Reports', state: 'active', accent: '#8d7aff', icon: '⌘', lastActivity: { en: 'Evidence preview', ar: 'معاينة الأدلة' }, owner: { en: 'System evidence', ar: 'أدلة النظام' } },
  { id: 'performance', name: { en: 'Performance Lab', ar: 'مختبر الأداء' }, code: 'PERF-08', section: 'performance', category: '08-Performance', state: 'active', accent: '#f0954f', icon: '↗', lastActivity: { en: 'Performance preview', ar: 'معاينة الأداء' }, owner: { en: 'Performance', ar: 'الأداء' } },
  { id: 'recovery', name: { en: 'Recovery Vault', ar: 'خزنة الاستعادة' }, code: 'REC-11', section: 'backupRecovery', category: '11-Backup-Recovery', state: 'active', accent: '#4cc6b2', icon: '◌', lastActivity: { en: 'Recovery preview', ar: 'معاينة الاستعادة' }, owner: { en: 'Recovery points', ar: 'نقاط الاستعادة' } },
  { id: 'developer', name: { en: 'Developer Station', ar: 'محطة المطوّر' }, code: 'DEV-12', section: 'developerTools', category: '12-Developer-Tools', state: 'active', accent: '#d36adb', icon: '⌘', lastActivity: { en: 'Toolchain preview', ar: 'معاينة الأدوات' }, owner: { en: 'Local environments', ar: 'البيئات المحلية' } },
  { id: 'disk', name: { en: 'Disk Pulse', ar: 'نبض القرص' }, code: 'DISK-06', section: 'disk', category: '06-Disk-Space', state: 'pinned', accent: '#a66cff', icon: '◒', lastActivity: { en: 'Storage preview', ar: 'معاينة التخزين' }, owner: { en: 'Storage capacity', ar: 'سعة التخزين' } },
  { id: 'privacy', name: { en: 'Privacy Guard', ar: 'حارس الخصوصية' }, code: 'PRIV-13', section: 'privacy', category: '13-Privacy', state: 'pinned', accent: '#e46e9d', icon: '◐', lastActivity: { en: 'Privacy preview', ar: 'معاينة الخصوصية' }, owner: { en: 'Privacy controls', ar: 'ضوابط الخصوصية' } },
  { id: 'software', name: { en: 'Software Inventory', ar: 'جرد البرامج' }, code: 'SOFT-16', section: 'softwareEnvironment', category: '16-Software-Environment', state: 'archived', accent: '#7d91a8', icon: '□', lastActivity: { en: 'Software preview', ar: 'معاينة البرامج' }, owner: { en: 'Software estate', ar: 'بيئة البرامج' } },
];
