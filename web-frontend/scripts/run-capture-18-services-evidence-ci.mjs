...
const hmrClassifier = `${anchor}
    ...
    const devHmrCspBlocked = /Connecting to 'ws:\\/\\/127\\.0\\.0\\.1:24678\\/\\?token=[^']+' violates the following Content Security Policy directive: "connect-src 'self' http:\\/\\/127\\.0\\.1:8787"\\. The action has been blocked\\./i.test(message);`;
