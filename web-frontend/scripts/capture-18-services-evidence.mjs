...
const ROUTES = [
  ...
  { family: 'assurance', service: '03-Network-Internet', name: 'Network & Internet', tools: 11, ownsActions: true },
  { family: 'assurance', service: '09-Security', name: 'Security', tools: 10, ownsActions: true },
  { family: 'assurance', service: '13-Privacy', name: 'Privacy', tools: 4, ownsActions: true },
  { family: 'assurance', service: '14-Driver-Management', name: 'Driver Management', tools: 4, ownsActions: true },
