...
#  knoux Repair v2.0.2 | 03-Network-Internet | NI05 - Refresh Network Tables
...
$Session = Start-KnouxSession -ToolId 'NI05' -ToolName 'Refresh Network Tables' -Category '03-Network-Internet' -RiskLevel 'SAFE_CLEANUP' -Mode $(if ($AnalyzeOnly) { 'analyze' } elseif ($WhatIf) { 'preview' } else { 'run' })
