...
$Session = Start-KnouxSession -ToolId 'NI03' -ToolName 'Flush DNS Cache' -Category '03-Network-Internet' -RiskLevel 'SAFE_CLEANUP' -Mode $(if ($AnalyzeOnly) { 'analyze' } elseif ($WhatIf) { 'preview' } else { 'run' })
