...
$Session = Start-KnouxSession -ToolId 'NI09' -ToolName 'Optimize TCP/IP Settings' -Category '03-Network-Internet' -RiskLevel 'SYSTEM_REPAIR' -Mode $(if ($AnalyzeOnly) { 'analyze' } elseif ($WhatIf) { 'preview' } else { 'run' })
