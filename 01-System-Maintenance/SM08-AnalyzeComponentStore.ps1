...
$Session = Start-KnouxSession -ToolId 'SM08' -ToolName 'Analyze Component Store' -Category '01-System-Maintenance' -RiskLevel 'READ_ONLY' -Mode $(if ($AnalyzeOnly) { 'analyze' } elseif ($WhatIf) { 'preview' } else { 'run' })
