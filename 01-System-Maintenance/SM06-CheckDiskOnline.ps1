...
$Session = Start-KnouxSession -ToolId 'SM06' -ToolName 'Check Disk Online' -Category '01-System-Maintenance' -RiskLevel 'READ_ONLY' -Mode $(if ($AnalyzeOnly) { 'analyze' } elseif ($WhatIf) { 'preview' } else { 'run' })
