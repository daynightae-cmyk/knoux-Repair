...
$Session = Start-KnouxSession -ToolId 'SC06' -ToolName 'Clean Update Download Cache' -Category '02-System-Cleanup' -RiskLevel 'SAFE_CLEANUP' -Mode $(if ($AnalyzeOnly) { 'analyze' } elseif ($WhatIf) { 'preview' } else { 'run' })
