...
$Session = Start-KnouxSession -ToolId 'SC03' -ToolName 'Clean Browser Cache' -Category '02-System-Cleanup' -RiskLevel 'SAFE_CLEANUP' -Mode $(if ($AnalyzeOnly) { 'analyze' } elseif ($WhatIf) { 'preview' } else { 'run' })
