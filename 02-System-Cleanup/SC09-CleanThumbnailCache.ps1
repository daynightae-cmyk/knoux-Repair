...
$Session = Start-KnouxSession -ToolId 'SC09' -ToolName 'Clean Thumbnail Cache' -Category '02-System-Cleanup' -RiskLevel 'SAFE_CLEANUP' -Mode $(if ($AnalyzeOnly) { 'analyze' } elseif ($WhatIf) { 'preview' } else { 'run' })
