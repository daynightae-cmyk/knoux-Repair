...
$Session = Start-KnouxSession -ToolId 'SC04' -ToolName 'Clean Windows Error Reports' -Category '02-System-Cleanup' -RiskLevel 'SAFE_CLEANUP' -Mode $(if ($AnalyzeOnly) { 'analyze' } elseif ($WhatIf) { 'preview' } else { 'run' })
