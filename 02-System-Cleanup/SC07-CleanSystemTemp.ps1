...
$Session = Start-KnouxSession -ToolId 'SC07' -ToolName 'Clean System Temp' -Category '02-System-Cleanup' -RiskLevel 'SAFE_CLEANUP' -Mode $(if ($AnalyzeOnly) { 'analyze' } elseif ($WhatIf) { 'preview' } else { 'run' })
